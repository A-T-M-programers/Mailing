...
class _List_progrmam_state extends State<List_program> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.messaging_pr!.getID != 0
        ? SwipeTo(
            offsetDx: 1,
                            ...
                            onPresed: () async {
                              if (home.checkadmin) {
                                if (await program_dataBase.Delete(
                                    widget.messaging_pr!.getID.toString())) {
                            ...
                            onPresed: () {
                              if (home.checkadmin) {
                                ...
                                Navigator.push(context,
                                  ...
                                  return message_page(
                                      "P", widget.messaging_pr!);
                                }));
                              }
                            }));
                  }
                : () {},
            rightSwipeWidget: home.checkadmin
                ? Container(
                ...
                : SizedBox(),
            leftSwipeWidget: home.checkadmin
                ? Container(
              ...
              Container(
                  ...
                  child: Stack(children: [
                    ...
                    Container(
                        ...
                        child: Container(
                            margin:
                                EdgeInsets.only(right: 20, top: 15, left: 20),
                    ...
                    Container(
                        ...
                        child: Container(
                            ...
                            child: ListView(
                              ...
                              children: widget
                                          .messaging_pr!.getlistimage.length >
                                      1
                                  ? List.generate(
                                      widget.messaging_pr!.getlistimage.length -
                                          1,
                                      (index) => show_photo_list(
                                          path: widget
                                              .messaging_pr!.getlistimage
                                              .elementAt(index + 1)
                                              .trim(),
                                          type: "N",
                                          index: index + 1))
                    ...
                    Container(
                        ...
                        child: Container(
                          ...
                          height:
                              (HieghDevice / 180) * (WidthDevice / 180) + 10,
                          ...
                          child: Container(
                            ...
                            child: Flex(direction: Axis.horizontal, children: [
                              Text('App Link: ',
                                  style: TextStyle(
                                      ...
                                      color: Colors.blue)),
                              Expanded(
                                  child: Text(widget.messaging_pr!.getlink,
                                      style: TextStyle(
                                          fontSize: (HieghDevice / 180) *
                                                  (WidthDevice / 180) +
                                              5,
                            ...
                            onPressed: () async {
                              if (widget.messaging_pr!.getlink
                                  .contains("https://")) {
                                if (await canLaunch(
                                    widget.messaging_pr!.getlink)) {
                                  launch(widget.messaging_pr!.getlink);
                                }
                              } else {
...
class _List_Partner_state extends State<List_partner> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.messaging_pp!.getID != 0
        ? SwipeTo(
            offsetDx: 1,
            animationDuration: Duration(milliseconds: 800),
            onLeftSwipe: home.checkadmin
                    ...
                    showDialog(
                        ...
                        builder: (context) => MyDialogeHome(
                            ...
                            onPresed: () async {
                              if (home.checkadmin) {
                                if (await program_dataBase.Delete(
                                    widget.messaging_pp!.getID.toString())) {
              ...
              Container(
                  ...
                  child: Stack(children: [
                    ...
                    Container(
                        ...
                        child: Container(
                            margin:
                                EdgeInsets.only(right: 20, top: 210, left: 20),
                            height: 70,
                            width: WidthDevice,
                            child: Text(
                    ...
                    Container(
                      ...
                      child: Container(
                          ...
                          child: FlatButton(
                            child: Flex(direction: Axis.horizontal, children: [
                              Text('App Link: ',
                                  style: TextStyle(
                                      ...
                                      color: Colors.blue)),
                              Expanded(
                                  child: Text('${widget.messaging_pp!.getlink}',
                                      style: TextStyle(
                                          fontSize: (HieghDevice / 180) *
                                                  (WidthDevice / 180) +
                                              5,
                            ...
                            onPressed: () async {
                              if (widget.messaging_pp!.getlink
                                  .contains("https://")) {
                                if (await canLaunch(
                                    widget.messaging_pp!.getlink)) {
                                  launch(widget.messaging_pp!.getlink);
                                }
                              } else {
                                if (await canLaunch("https://" +
                                    widget.messaging_pp!.getlink)) {
